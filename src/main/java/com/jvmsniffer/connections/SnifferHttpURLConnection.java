...
public class SnifferHttpURLConnection extends HttpURLConnection
{
    private HttpURLConnection itsRealConnection;
     ...
     * @param u the URL
     */
    public SnifferHttpURLConnection(URL u, HttpURLConnection aRealConnection)
    {
        super(u);
